...
def VGG16(pretrained_weight='imagenet', trainable=True):
    ...
    conv_block1 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(conv_block1)
    ...
    conv_block2 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(conv_block2)
    ...
    conv_block3 = Conv2D(filters=256,
                         ...
                         padding='same',
                         activation='relu')(conv_block3)
    conv_block3 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(conv_block3)
    ...
    conv_block4 = Conv2D(filters=512,
                         ...
                         padding='same',
                         activation='relu')(conv_block4)
    conv_block4 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(conv_block4)
